...
export const infos: Info[] = infoSeed.map(([title, source, channel_id, info_type, content, tag_ids, price_text, location_text, contact_text], index) => ({
  ...
  location_address: title.includes("The Floravale") ? "240 Westwood Ave Singapore 648361" : null,
  location_postal: title.includes("The Floravale") ? "648361" : null,
  location_lat: title.includes("The Floravale") ? 1.3529 : null,
  location_lng: title.includes("The Floravale") ? 103.701 : null,
  location_source: title.includes("The Floravale") ? "mock" : null,
  location_raw: null,
  source_type: "admin",
